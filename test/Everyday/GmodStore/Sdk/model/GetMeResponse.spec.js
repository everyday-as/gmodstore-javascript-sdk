...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.GetMeResponse();
  });
  ...
  describe('GetMeResponse', function() {
    it('should create an instance of GetMeResponse', function() {
      // uncomment below and update the code to test GetMeResponse
      //var instance = new GmodstoreSdk.GetMeResponse();
      //expect(instance).to.be.a(GmodstoreSdk.GetMeResponse);
    });
