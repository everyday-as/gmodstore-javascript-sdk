...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.UpdateProductVersionPayload();
  });
  ...
  describe('UpdateProductVersionPayload', function() {
    it('should create an instance of UpdateProductVersionPayload', function() {
      // uncomment below and update the code to test UpdateProductVersionPayload
      //var instance = new GmodstoreSdk.UpdateProductVersionPayload();
      //expect(instance).to.be.a(GmodstoreSdk.UpdateProductVersionPayload);
    });
