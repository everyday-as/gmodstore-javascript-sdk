...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodStoreApi.AddonStatsSales();
  });
  ...
  describe('AddonStatsSales', function() {
    it('should create an instance of AddonStatsSales', function() {
      // uncomment below and update the code to test AddonStatsSales
      //var instane = new GmodStoreApi.AddonStatsSales();
      //expect(instance).to.be.a(GmodStoreApi.AddonStatsSales);
    });
