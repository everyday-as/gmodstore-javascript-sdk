...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodStoreApi.AddonStatsViews();
  });
  ...
  describe('AddonStatsViews', function() {
    it('should create an instance of AddonStatsViews', function() {
      // uncomment below and update the code to test AddonStatsViews
      //var instane = new GmodStoreApi.AddonStatsViews();
      //expect(instance).to.be.a(GmodStoreApi.AddonStatsViews);
    });
