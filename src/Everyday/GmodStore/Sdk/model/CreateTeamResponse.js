 ...
 * @module Everyday/GmodStore/Sdk/model/CreateTeamResponse
 * @version 3.0.0
 */
class CreateTeamResponse {
    /**
     * Constructs a new <code>CreateTeamResponse</code>.
     * @alias module:Everyday/GmodStore/Sdk/model/CreateTeamResponse
     * @param data {module:Everyday/GmodStore/Sdk/model/Team} 
     */
    constructor(data) { 
        
        CreateTeamResponse.initialize(this, data);
    }
     ...
     * @param {module:Everyday/GmodStore/Sdk/model/CreateTeamResponse} obj Optional instance to populate.
     * @return {module:Everyday/GmodStore/Sdk/model/CreateTeamResponse} The populated <code>CreateTeamResponse</code> instance.
     */
