...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.UpdateProductCouponPayload();
  });
  ...
  describe('UpdateProductCouponPayload', function() {
    it('should create an instance of UpdateProductCouponPayload', function() {
      // uncomment below and update the code to test UpdateProductCouponPayload
      //var instance = new GmodstoreSdk.UpdateProductCouponPayload();
      //expect(instance).to.be.a(GmodstoreSdk.UpdateProductCouponPayload);
    });
