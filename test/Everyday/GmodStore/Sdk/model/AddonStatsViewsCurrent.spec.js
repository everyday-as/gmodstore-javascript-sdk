...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodStoreApi.AddonStatsViewsCurrent();
  });
  ...
  describe('AddonStatsViewsCurrent', function() {
    it('should create an instance of AddonStatsViewsCurrent', function() {
      // uncomment below and update the code to test AddonStatsViewsCurrent
      //var instane = new GmodStoreApi.AddonStatsViewsCurrent();
      //expect(instance).to.be.a(GmodStoreApi.AddonStatsViewsCurrent);
    });
