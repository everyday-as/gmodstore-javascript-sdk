...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.NewUserBadgePayload();
  });
  ...
  describe('NewUserBadgePayload', function() {
    it('should create an instance of NewUserBadgePayload', function() {
      // uncomment below and update the code to test NewUserBadgePayload
      //var instance = new GmodstoreSdk.NewUserBadgePayload();
      //expect(instance).to.be.a(GmodstoreSdk.NewUserBadgePayload);
    });
