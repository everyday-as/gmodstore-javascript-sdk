...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.ConnectionPaginatedMeta();
  });
  ...
  describe('ConnectionPaginatedMeta', function() {
    it('should create an instance of ConnectionPaginatedMeta', function() {
      // uncomment below and update the code to test ConnectionPaginatedMeta
      //var instance = new GmodstoreSdk.ConnectionPaginatedMeta();
      //expect(instance).to.be.a(GmodstoreSdk.ConnectionPaginatedMeta);
    });
