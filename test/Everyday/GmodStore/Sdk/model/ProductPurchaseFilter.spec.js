...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.ProductPurchaseFilter();
  });
  ...
  describe('ProductPurchaseFilter', function() {
    it('should create an instance of ProductPurchaseFilter', function() {
      // uncomment below and update the code to test ProductPurchaseFilter
      //var instance = new GmodstoreSdk.ProductPurchaseFilter();
      //expect(instance).to.be.a(GmodstoreSdk.ProductPurchaseFilter);
    });
