...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodStoreApi.AddonStatsSalesCurrent();
  });
  ...
  describe('AddonStatsSalesCurrent', function() {
    it('should create an instance of AddonStatsSalesCurrent', function() {
      ...
      //var instane = new GmodStoreApi.AddonStatsSalesCurrent();
      //expect(instance).to.be.a(GmodStoreApi.AddonStatsSalesCurrent);
    });
