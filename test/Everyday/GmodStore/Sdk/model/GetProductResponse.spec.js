...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.GetProductResponse();
  });
  ...
  describe('GetProductResponse', function() {
    it('should create an instance of GetProductResponse', function() {
      // uncomment below and update the code to test GetProductResponse
      //var instance = new GmodstoreSdk.GetProductResponse();
      //expect(instance).to.be.a(GmodstoreSdk.GetProductResponse);
    });
