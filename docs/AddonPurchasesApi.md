...
let apiInstance = new GmodStore.AddonPurchasesApi();
let addonId = 789; // Number | Id of the addon
let newAddonPurchase = new GmodStore.NewAddonPurchase(); // NewAddonPurchase | 
let opts = {
...
let addonId = 789; // Number | Id of the addon
let userId = 789; // Number | Id of the user
let addonPurchase = new GmodStore.AddonPurchase(); // AddonPurchase | 
let opts = {
  '_with': ["null"] // [String] | The relations you want to fetch with the `AddonPurchase`
};
