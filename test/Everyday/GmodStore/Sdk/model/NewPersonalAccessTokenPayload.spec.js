...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.NewPersonalAccessTokenPayload();
  });
  ...
  describe('NewPersonalAccessTokenPayload', function() {
    it('should create an instance of NewPersonalAccessTokenPayload', function() {
      // uncomment below and update the code to test NewPersonalAccessTokenPayload
      //var instance = new GmodstoreSdk.NewPersonalAccessTokenPayload();
      //expect(instance).to.be.a(GmodstoreSdk.NewPersonalAccessTokenPayload);
    });
