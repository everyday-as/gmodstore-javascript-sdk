...
(function(root, factory) {
  ...
  describe('PermissionGroupsApi', function() {
    describe('getPermissionGroups', function() {
      it('should call getPermissionGroups successfully', function(done) {
        //uncomment below and update the code to test getPermissionGroups
        //instance.getPermissionGroups(function(error) {
