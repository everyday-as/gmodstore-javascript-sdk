...
export default class UserProductPurchasesApi {
    ...
    /**
    * Constructs a new UserProductPurchasesApi. 
    * @alias module:Everyday/GmodStore/Sdk/api/UserProductPurchasesApi
    * @class
    ...
    */
     ...
     * @callback module:Everyday/GmodStore/Sdk/api/UserProductPurchasesApi~listUserPurchasesCallback
     ...
     * @param {module:Everyday/GmodStore/Sdk/api/UserProductPurchasesApi~listUserPurchasesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    listUserPurchases(user, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'user' is set
      if (user === undefined || user === null) {
        throw new Error("Missing the required parameter 'user' when calling listUserPurchases");
      }
      ...
      return this.apiClient.callApi(
        '/api/v3/users/{user}/purchases', 'GET',
