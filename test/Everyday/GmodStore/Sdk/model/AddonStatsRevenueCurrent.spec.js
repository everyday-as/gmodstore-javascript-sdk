...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodStore.AddonStatsRevenueCurrent();
  });
  ...
  describe('AddonStatsRevenueCurrent', function() {
    it('should create an instance of AddonStatsRevenueCurrent', function() {
      ...
      //var instane = new GmodStore.AddonStatsRevenueCurrent();
      //expect(instance).to.be.a(GmodStore.AddonStatsRevenueCurrent);
    });
