...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodStoreApi.AddonStatsRevenue();
  });
  ...
  describe('AddonStatsRevenue', function() {
    it('should create an instance of AddonStatsRevenue', function() {
      // uncomment below and update the code to test AddonStatsRevenue
      //var instane = new GmodStoreApi.AddonStatsRevenue();
      //expect(instance).to.be.a(GmodStoreApi.AddonStatsRevenue);
    });
