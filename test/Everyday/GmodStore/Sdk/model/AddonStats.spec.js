...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodStoreApi.AddonStats();
  });
  ...
  describe('AddonStats', function() {
    it('should create an instance of AddonStats', function() {
      // uncomment below and update the code to test AddonStats
      //var instane = new GmodStoreApi.AddonStats();
      //expect(instance).to.be.a(GmodStoreApi.AddonStats);
    });
