...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmodstoreSdk.ApiKeyResponse();
  });
  ...
  describe('ApiKeyResponse', function() {
    it('should create an instance of ApiKeyResponse', function() {
      ...
      //var instane = new GmodstoreSdk.ApiKeyResponse();
      //expect(instance).to.be.a(GmodstoreSdk.ApiKeyResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new GmodstoreSdk.ApiKeyResponse();
